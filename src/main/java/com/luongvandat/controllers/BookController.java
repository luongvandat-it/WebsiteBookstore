...
public class BookController {
    ...
    public BookController(BookServices bookServices, CategoryServices categoryServices, PublisherServices publisherServices, AuthorServices authorService, SupplierServices supplierService) {
        this.bookServices = bookServices;
        this.categoryServices = categoryServices;
        this.publisherServices = publisherServices;
        this.authorServices = authorService;
        this.supplierServices = supplierService;
    }
